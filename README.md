...
A Cursor extension that integrates [deepseek-cursor-proxy](https://github.com/yxlao/deepseek-cursor-proxy). It provides a visual control panel to start/stop the proxy, copy the Base URL, and view logs — all inside the IDE, without switching to a terminal.
...
2. Wait for **Running** and a Base URL
3. Click **Copy Base URL**
4. Open **Cursor Settings → Models**, enter Base URL and DeepSeek API Key
5. Add model `deepseek-v4-pro`
